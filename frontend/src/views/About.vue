<template>
  ...
  <div class="about-page">
    ...
    <p>本站是一个非营利性的个人音乐网站，代码已开源在<a href="https://github.com/HarvestMoons/BeeMusic" target="_blank"
      ...
      彩&#8203;蛋：<span
          style="color: transparent">在主页面，长按E键可以观看随机逆天视频。在统计图表中，连续敲击空虚的中心七次，或许能听到灵魂的共鸣。</span>
    </p>
